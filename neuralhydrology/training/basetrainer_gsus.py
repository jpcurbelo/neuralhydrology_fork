...
class BaseTrainer(object):
    ...
    def initialize_training(self):
        ...
        # print(f'in basetrainer, ds is: ', ds)
        # print(f'ds.cfg is: ', ds.cfg)

        if len(ds) == 0:
            raise ValueError("Dataset contains no samples.")
        self.loader = self._get_data_loader(ds=ds)

        # print(f'in basetrainer, self.loader is: ', self.loader)
        ...
        # print(f'in basetrainer, self.optimizer is: ', self.optimizer)
        # print(f'in basetrainer, self.loss_obj is: ', self.loss_obj)
    ...
    def train_and_validate(self):
        ...
        for epoch in range(self._epoch + 1, self._epoch + self.cfg.epochs + 1):
            ...
            # print('in basetrainer, avg_losses are: ', loss_str)
    ...
    def _train_epoch(self, epoch: int):
        # print('in basetrainer, _train_epoch, epoch is: ', epoch, ' before self.model.train()')
        self.model.train()
        # print('in basetrainer, _train_epoch, epoch is: ', epoch, ' after self.model.train()')
        ...
        for i, data in enumerate(pbar):
            ...
            # print('in basetrainer, data is: ', i, data['date'].shape)

            # print('in basetrainer, data is: ', i, data['date'][0])
            ...
            # get predictions
            # print('\n in basetrainer, data is: ', i, data['date'].shape, 'before self.model(data)')
            predictions = self.model(data)
            # print('\n in basetrainer, predictions-y_hat are: ', predictions['y_hat'].shape, 'after self.model(data)')
            # print('\n in basetrainer, predictions are: ', predictions.keys(), 'after self.model(data)')
            ...
            # print('\n in basetrainer, data is: ', i, data['date'].shape, 'before self.loss_obj(predictions, data)')

            loss, all_losses = self.loss_obj(predictions, data)

            # print('in basetrainer, loss is: ', loss)
            # print('in basetrainer, all_losses are: ', all_losses)
            # exit(0)
